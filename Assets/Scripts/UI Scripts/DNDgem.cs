...
/// Drag and Drop item.
/// </summary>
public class DNDgem : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
{
	public static bool dragDisabled = false;										// Drag start global disable

	public static DNDgem draggedItem;                                      // Item that is dragged now
	public static GameObject icon;                                                  // Icon of dragged item
	public static DNDslot sourceCell;                                       // From this cell dragged item is

	public delegate void DragEvent(DNDgem item);
	...
	public void OnDrag(PointerEventData data)
	{
		if (icon != null)
		{
			icon.transform.position = data.position;                          // Item's icon follows to cursor in screen pixels
		}
	}
	...
	public DNDslot GetCell()
	{
		return GetComponentInParent<DNDslot>();
	}
